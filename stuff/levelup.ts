...
const messages = core.Messages.loadMessages('rstk-sfdx-package-utils', 'levelup');
...
export default class Org extends SfdxCommand {
  ...
  `$ sfdx rstk:package:dependencies:levelup --targetusername myOrg@example.com --targetdevhubusername devhub@org.com
  `
  ];
